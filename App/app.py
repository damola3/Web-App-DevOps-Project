...
server_value = secret_client.get_secret("server-name")
database_value = secret_client.get_secret("database")
username_value = secret_client.get_secret("username")
password_value = secret_client.get_secret("Password")
